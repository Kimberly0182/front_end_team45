...
export const getTwitterGeoData = async () => {
  try {
    const response = await axios.get("http://172.26.135.47:5566/twitter_geo");
...
export const getTwitterLanguageData = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/twitter_language"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getTwitterAncestryData = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/twitter_ancestry"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getTwitterEmoji = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/twitter_emoji_count"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getTwitterPositive = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/twitter_sentiment_emoji_count?sentiment=Positive"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getTwitterNegative = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/twitter_sentiment_emoji_count?sentiment=Negative"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getTwitterNeutral = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/twitter_sentiment_emoji_count?sentiment=Neutral"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getMastodonEmoji = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/mastodon_emoji_count"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getMastodonPositive = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/mastodon_sentiment_emoji_count?sentiment=Positive"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getMastodonNegative = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/mastodon_sentiment_emoji_count?sentiment=Negative"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getMastodonNeutral = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/mastodon_sentiment_emoji_count?sentiment=Neutral"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getTwitterSentiment = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/twitter_sentiment_count"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
...
export const getMastodonSentiment = async () => {
  try {
    const response = await axios.get(
      "http://172.26.135.47:5566/mastodon_sentiment_count"
    );
    if (response.data.status === "success") {
      return response.data.data;
    } else {
